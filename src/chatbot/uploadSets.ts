...
export const UPLOAD_SETS: Record<UploadSet, UploadDef> = {
  contract: {
    ...
    detection: {
      ...
      actions: [
        { id: 'extract',  icon: 'table',     label: 'Extraire en tableau', desc: 'Données structurées du contrat' },
        { id: 'traduire', icon: 'languages', label: 'Traduire', badge: 'Allemand détecté' },
        { id: 'counsel',  label: 'Flow Counsel', flow: 'counsel', desc: 'Risques, clauses, incohérences' },
      ],
    },
  },
  ndas: {
    ...
    detection: {
      ...
      actions: [
        { id: 'compare', icon: 'columns', label: 'Comparer', desc: 'Différences entre les deux' },
        { id: 'extract', icon: 'table',   label: 'Extraire en tableau', desc: 'Données structurées' },
        { id: 'counsel', label: 'Flow Counsel', flow: 'counsel', desc: 'Risques, clauses, incohérences' },
      ],
    },
  },
  pack: {
    ...
    detection: {
      ...
      actions: [
        { id: 'extract',  icon: 'table', label: 'Extraire en tableau', desc: 'Données structurées' },
        { id: 'litigate', label: 'Flow Litigate', flow: 'litigate', desc: 'Citer, numéroter, contrer' },
      ],
    },
  },
  bulk: {
    ...
    detection: {
      ...
      actions: [
        { id: 'extract', icon: 'table', label: 'Extraire en tableau', desc: 'Données structurées' },
        { id: 'sources', icon: 'scan',  label: 'Détecter les sources', desc: 'Repérer les sources citées' },
      ],
    },
  },
  conclusions: {
    ...
    detection: {
      ...
      actions: [
        { id: 'contre',   icon: 'columns', label: 'Contre-arguments', desc: 'Réfuter les écritures adverses' },
        { id: 'litigate', label: 'Flow Litigate', flow: 'litigate', desc: 'Citer vos pièces, bordereau' },
      ],
    },
  },
};
